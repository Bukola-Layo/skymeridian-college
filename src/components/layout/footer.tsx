                ...
                <li className="pt-2">
                  <div className="flex items-center gap-3">
                    <a
                      ...
                      className="flex h-9 w-9 items-center justify-center rounded-full bg-white/10 text-white/70 transition-colors hover:bg-sky-gold hover:text-meridian-navy"
                      aria-label="Facebook"
                    >
